        ...
        >
          ...
          {recipientAddress && sendAmount ? (
            <div className="space-y-4">
              <div className="flex flex-col items-center gap-4 text-center">
                ...
                <div className={`text-sm ${isDarkMode ? "text-slate-200" : "text-slate-700"}`}>
                  Share this code to send <strong>{sendAmount} ETH</strong> to {truncateAddress(recipientAddress)}.
                </div>
              </div>
              <Button
            ...
            <p className={`text-sm ${isDarkMode ? "text-slate-300" : "text-slate-600"}`}>
              Enter a recipient wallet and the amount to create a QR code for the transfer.
            </p>
          )}
        </section>
      </div>
