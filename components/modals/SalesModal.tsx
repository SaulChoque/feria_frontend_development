				...
				<header className="space-y-2 text-center sm:text-left">
					...
					<div>
						...
						<p className="mt-2 text-sm text-white/70">
							Controla el estado de tus pedidos y mantén informados a tus
							compradores.
						</p>
					</div>
				</header>
								...
								{getUserSalesProducts().map((product) => (
									...
									>
										<div className="flex items-center justify-between">
											...
											<div className="ml-3">
												{(!product.saleStatus ||
													product.saleStatus === "pago_recibido") && (
									...
									<div className="flex-1 space-y-3">
										<div>
											...
											<p className="text-3xl font-bold text-[#ff9800]">
												${selectedSaleProduct.price} USDC
											</p>
										</div>
										<div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
											<div className="rounded-lg border border-white/20 bg-white/10 p-3">
												...
												<p className="text-sm font-medium text-white">
													{selectedSaleProduct.condition}
												</p>
											</div>
											<div className="rounded-lg border border-white/20 bg-white/10 p-3">
												<p className="text-xs text-white/60">Categoría</p>
												<p className="text-sm font-medium text-white">
													{selectedSaleProduct.category}
												</p>
											</div>
										</div>
									</div>
											...
											{[
												...
												return (
													...
													>
														...
														<span className="text-center text-xs text-white/80 whitespace-pre-line">
															{label}
														</span>
													</div>
												);
