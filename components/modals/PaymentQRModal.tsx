    ...
    >
      <div className="space-y-6 text-center sm:text-left">
        <header className="space-y-2">
          ...
          <h2 className="text-2xl font-bold sm:text-3xl">Completa tu depósito</h2>
          <p className="text-sm text-white/70">
            Usa tu aplicación de pagos favorita para escanear este código QR y confirmar el depósito.
          </p>
        </header>
        ...
        {pendingDepositData && (
          <div className="rounded-2xl border border-white/20 bg-white/5 p-4 text-sm text-white/80">
            ...
            <p className="text-sm text-white/70">Recibirás {pendingDepositData.usdc} USDC</p>
            <p className="mt-2 text-xs text-white/60">Tasa: 1 USD = {usdcRate} Bs</p>
          </div>
        )}
        ...
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <div className="space-y-1 text-sm text-white/70">
            ...
            <p className="text-xs text-white/60">Una vez realizado el pago, confirma la transacción.</p>
            <p className="text-xs text-white/60">🕐 Este QR expira en 15 minutos.</p>
          </div>
        </div>
