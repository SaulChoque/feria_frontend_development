			...
			<div className="space-y-6 text-center sm:text-left">
				<div className="space-y-2">
					...
					<p className="text-sm text-white/70">
						Escanea o copia tu dirección para recibir ETH en la red de prueba
						Sepolia.
					</p>
				</div>
				...
				<div className="flex flex-col items-center gap-4 text-center">
					...
					<p className="text-sm text-white/70">
						Comparte este código QR para recibir fondos.
					</p>
				</div>
				...
				<div className="space-y-2 text-left">
					...
					<div className="rounded-2xl border border-white/20 bg-white/5 p-3">
						<p className="break-all font-mono text-sm text-[#00bcd4]">
							{walletAddress}
						</p>
					</div>
				</div>
