		...
		>
			...
			>
				<div className="relative mb-3 sm:mb-4">
					<div className="relative overflow-hidden rounded-xl w-full h-36 sm:h-48">
						<Image
					...
					{!product.inStock && (
						<Badge
							variant="destructive"
							className="absolute top-2 sm:top-3 left-2 sm:left-3 animate-pulse text-xs"
						>
							Out of Stock
						</Badge>
					)}
			...
			<CardFooter className="p-3 sm:p-4 pt-0 space-y-2 sm:space-y-3 relative z-20">
				...
				<Button
					...
					onClick={(e) => {
						...
						e.preventDefault();
						console.log(
							"Contact seller button clicked for product:",
							product.id
						);
